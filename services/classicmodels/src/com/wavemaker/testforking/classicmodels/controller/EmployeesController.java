...
import com.wavemaker.testforking.classicmodels.service.EmployeesService;
...
public class EmployeesController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Employees getEmployees(@PathVariable("employeeNumber") Integer employeeNumber) {
        LOGGER.debug("Getting Employees with id: {}" , employeeNumber);

        Employees foundEmployees = employeesService.getById(employeeNumber);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Employees editEmployees(@PathVariable("employeeNumber") Integer employeeNumber, @RequestBody Employees employees) {
    ...
    @RequestMapping(value = "/{employeeNumber:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Employees patchEmployees(@PathVariable("employeeNumber") Integer employeeNumber, @RequestBody @MapTo(Employees.class) Map<String, Object> employeesPatch) {
        LOGGER.debug("Partially updating Employees with id: {}" , employeeNumber);

        Employees employees = employeesService.partialUpdate(employeeNumber, employeesPatch);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteEmployees(@PathVariable("employeeNumber") Integer employeeNumber) {
        LOGGER.debug("Deleting Employees with id: {}" , employeeNumber);

        Employees deletedEmployees = employeesService.delete(employeeNumber);
    ...
    @RequestMapping(value="/{employeeNumber:.+}/customerses", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the customerses instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Customers> findAssociatedCustomerses(@PathVariable("employeeNumber") Integer employeeNumber, Pageable pageable) {

        LOGGER.debug("Fetching all associated customerses");
        return employeesService.findAssociatedCustomerses(employeeNumber, pageable);
    }

    @RequestMapping(value="/{employeeNumber:.+}/employeesesForReportsTo", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the employeesesForReportsTo instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Employees> findAssociatedEmployeesesForReportsTo(@PathVariable("employeeNumber") Integer employeeNumber, Pageable pageable) {

        LOGGER.debug("Fetching all associated employeesesForReportsTo");
        return employeesService.findAssociatedEmployeesesForReportsTo(employeeNumber, pageable);
    }
