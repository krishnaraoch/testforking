...
import com.wavemaker.testforking.classicmodels.service.CustomersService;
...
public class CustomersController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Customers getCustomers(@PathVariable("customerNumber") Integer customerNumber) {
        LOGGER.debug("Getting Customers with id: {}" , customerNumber);

        Customers foundCustomers = customersService.getById(customerNumber);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Customers editCustomers(@PathVariable("customerNumber") Integer customerNumber, @RequestBody Customers customers) {
    ...
    @RequestMapping(value = "/{customerNumber:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Customers patchCustomers(@PathVariable("customerNumber") Integer customerNumber, @RequestBody @MapTo(Customers.class) Map<String, Object> customersPatch) {
        LOGGER.debug("Partially updating Customers with id: {}" , customerNumber);

        Customers customers = customersService.partialUpdate(customerNumber, customersPatch);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteCustomers(@PathVariable("customerNumber") Integer customerNumber) {
        LOGGER.debug("Deleting Customers with id: {}" , customerNumber);

        Customers deletedCustomers = customersService.delete(customerNumber);
    ...
    @RequestMapping(value="/{customerNumber:.+}/orderses", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the orderses instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Orders> findAssociatedOrderses(@PathVariable("customerNumber") Integer customerNumber, Pageable pageable) {

        LOGGER.debug("Fetching all associated orderses");
        return customersService.findAssociatedOrderses(customerNumber, pageable);
    }

    @RequestMapping(value="/{customerNumber:.+}/paymentses", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the paymentses instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Payments> findAssociatedPaymentses(@PathVariable("customerNumber") Integer customerNumber, Pageable pageable) {

        LOGGER.debug("Fetching all associated paymentses");
        return customersService.findAssociatedPaymentses(customerNumber, pageable);
    }
