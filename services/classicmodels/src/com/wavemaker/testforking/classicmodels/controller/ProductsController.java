...
import com.wavemaker.testforking.classicmodels.service.ProductsService;
...
public class ProductsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Products getProducts(@PathVariable("productCode") String productCode) {
        LOGGER.debug("Getting Products with id: {}" , productCode);

        Products foundProducts = productsService.getById(productCode);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Products editProducts(@PathVariable("productCode") String productCode, @RequestBody Products products) {
    ...
    @RequestMapping(value = "/{productCode:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Products patchProducts(@PathVariable("productCode") String productCode, @RequestBody @MapTo(Products.class) Map<String, Object> productsPatch) {
        LOGGER.debug("Partially updating Products with id: {}" , productCode);

        Products products = productsService.partialUpdate(productCode, productsPatch);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteProducts(@PathVariable("productCode") String productCode) {
        LOGGER.debug("Deleting Products with id: {}" , productCode);

        Products deletedProducts = productsService.delete(productCode);
    ...
    @RequestMapping(value="/{productCode:.+}/orderdetailses", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the orderdetailses instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Orderdetails> findAssociatedOrderdetailses(@PathVariable("productCode") String productCode, Pageable pageable) {

        LOGGER.debug("Fetching all associated orderdetailses");
        return productsService.findAssociatedOrderdetailses(productCode, pageable);
    }
