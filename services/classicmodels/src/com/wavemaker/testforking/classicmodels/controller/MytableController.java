...
import com.wavemaker.testforking.classicmodels.Mytable;
import com.wavemaker.testforking.classicmodels.MytableId;
import com.wavemaker.testforking.classicmodels.service.MytableService;
...
public class MytableController {
	...
	@ApiOperation(value = "Partially updates the  Mytable instance associated with the given composite-id.")
	@RequestMapping(value = "/composite-id", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Mytable patchMytable(@RequestParam("columnB") Integer columnB, @RequestParam("columnA") Integer columnA, @RequestBody @MapTo(Mytable.class) Map<String, Object> mytablePatch) {

        MytableId mytableId = new MytableId();
        mytableId.setColumnB(columnB);
        mytableId.setColumnA(columnA);
        LOGGER.debug("Partially updating Mytable with id: {}" , mytableId);

        Mytable mytable = mytableService.partialUpdate(mytableId, mytablePatch);
        LOGGER.debug("Mytable details after partial update: {}" , mytable);
	...
	@ApiOperation(value = "Returns the total count of Mytable instances matching the optional query (q) request param.")
