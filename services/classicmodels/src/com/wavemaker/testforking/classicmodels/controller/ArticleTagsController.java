...
import com.wavemaker.testforking.classicmodels.service.ArticleTagsService;
...
public class ArticleTagsController {
	...
	@ApiOperation(value = "Partially updates the  ArticleTags instance associated with the given composite-id.")
	@RequestMapping(value = "/composite-id", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public ArticleTags patchArticleTags(@RequestParam("articleId") Integer articleId, @RequestParam("tagId") Integer tagId, @RequestBody @MapTo(ArticleTags.class) Map<String, Object> articleTagsPatch) {

        ArticleTagsId articletagsId = new ArticleTagsId();
        articletagsId.setArticleId(articleId);
        articletagsId.setTagId(tagId);
        LOGGER.debug("Partially updating ArticleTags with id: {}" , articletagsId);

        ArticleTags articleTags = articleTagsService.partialUpdate(articletagsId, articleTagsPatch);
        LOGGER.debug("ArticleTags details after partial update: {}" , articleTags);
