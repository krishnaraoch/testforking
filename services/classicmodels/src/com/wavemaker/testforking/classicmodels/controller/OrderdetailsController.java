...
import com.wavemaker.testforking.classicmodels.OrderdetailsId;
import com.wavemaker.testforking.classicmodels.service.OrderdetailsService;
...
public class OrderdetailsController {
	...
	@ApiOperation(value = "Partially updates the  Orderdetails instance associated with the given composite-id.")
	@RequestMapping(value = "/composite-id", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Orderdetails patchOrderdetails(@RequestParam("orderNumber") Integer orderNumber, @RequestParam("productCode") String productCode, @RequestBody @MapTo(Orderdetails.class) Map<String, Object> orderdetailsPatch) {

        OrderdetailsId orderdetailsId = new OrderdetailsId();
        orderdetailsId.setOrderNumber(orderNumber);
        orderdetailsId.setProductCode(productCode);
        LOGGER.debug("Partially updating Orderdetails with id: {}" , orderdetailsId);

        Orderdetails orderdetails = orderdetailsService.partialUpdate(orderdetailsId, orderdetailsPatch);
        LOGGER.debug("Orderdetails details after partial update: {}" , orderdetails);
