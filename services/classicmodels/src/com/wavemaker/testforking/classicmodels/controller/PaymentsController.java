...
import com.wavemaker.testforking.classicmodels.PaymentsId;
import com.wavemaker.testforking.classicmodels.service.PaymentsService;
...
public class PaymentsController {
	...
	@ApiOperation(value = "Partially updates the  Payments instance associated with the given composite-id.")
	@RequestMapping(value = "/composite-id", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Payments patchPayments(@RequestParam("checkNumber") String checkNumber, @RequestParam("customerNumber") Integer customerNumber, @RequestBody @MapTo(Payments.class) Map<String, Object> paymentsPatch) {

        PaymentsId paymentsId = new PaymentsId();
        paymentsId.setCheckNumber(checkNumber);
        paymentsId.setCustomerNumber(customerNumber);
        LOGGER.debug("Partially updating Payments with id: {}" , paymentsId);

        Payments payments = paymentsService.partialUpdate(paymentsId, paymentsPatch);
        LOGGER.debug("Payments details after partial update: {}" , payments);
