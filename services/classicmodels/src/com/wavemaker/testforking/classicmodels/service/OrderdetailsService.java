...
public interface OrderdetailsService {
    ...
    /**
     * Partially updates the details of an existing Orderdetails. It updates only the
     * fields of the existing Orderdetails which are passed in the orderdetailsPatch.
     *
     * This method overrides the input field values using Server side or database managed properties defined on Orderdetails if any.
     *
     * @param orderdetailsId The id of the Orderdetails to be deleted; value cannot be null.
     * @param orderdetailsPatch The partial data of Orderdetails which is supposed to be updated; value cannot be null.
     * @return The updated Orderdetails.
     * @throws EntityNotFoundException if no Orderdetails is found with given input.
     */
    Orderdetails partialUpdate(OrderdetailsId orderdetailsId, Map<String, Object> orderdetailsPatch);
