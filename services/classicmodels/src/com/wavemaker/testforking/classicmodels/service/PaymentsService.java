...
public interface PaymentsService {
    ...
    /**
     * Partially updates the details of an existing Payments. It updates only the
     * fields of the existing Payments which are passed in the paymentsPatch.
     *
     * This method overrides the input field values using Server side or database managed properties defined on Payments if any.
     *
     * @param paymentsId The id of the Payments to be deleted; value cannot be null.
     * @param paymentsPatch The partial data of Payments which is supposed to be updated; value cannot be null.
     * @return The updated Payments.
     * @throws EntityNotFoundException if no Payments is found with given input.
     */
    Payments partialUpdate(PaymentsId paymentsId, Map<String, Object> paymentsPatch);
