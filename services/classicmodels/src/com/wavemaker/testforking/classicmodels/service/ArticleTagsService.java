...
public interface ArticleTagsService {
    ...
    /**
     * Partially updates the details of an existing ArticleTags. It updates only the
     * fields of the existing ArticleTags which are passed in the articleTagsPatch.
     *
     * This method overrides the input field values using Server side or database managed properties defined on ArticleTags if any.
     *
     * @param articletagsId The id of the ArticleTags to be deleted; value cannot be null.
     * @param articleTagsPatch The partial data of ArticleTags which is supposed to be updated; value cannot be null.
     * @return The updated ArticleTags.
     * @throws EntityNotFoundException if no ArticleTags is found with given input.
     */
    ArticleTags partialUpdate(ArticleTagsId articletagsId, Map<String, Object> articleTagsPatch);
